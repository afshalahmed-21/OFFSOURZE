...
<link rel="stylesheet" href="Assets/css/WhiteLabling.css">

<section>
    <div class="innerMainBannerBg">
        <div class="container">
            <div class="col-lg-6 m-auto text-center mainBannerHeading mt-5 pt-4 pb-4">
                <img class="w-100" src="Assets/images/WhitLabling/WhiteLabelingText-02.png" alt="">
                <h1><strong>White </strong> Labeling</h1>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="DigitalStartupsSetionFive">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 m-auto" data-aos="fade-left">
                    <img class="w-75 m-auto d-block mb-5 pb-5 DigitalStartupsSetionImg02" src="Assets/images/WhitLabling/WhiteLabelingSecondIcon-02.png" alt="">
                </div>
            </div>
        </div>
    </div>
...
<section class="WhiteLablingFirstBg">
    <div class="container">
        <div class="row">
...
<section class="WhiteLablingSecondBg">
    <div class="container">
        <div class="row">
            <div class="col-lg-6 m-auto" data-aos="fade-right">
                <h2>
...
<section class="WhiteLablingThirdBg">
    <div class="container">
        <div class="row">
            <img class="MainSectionImg06" src="Assets/images/HomePage/MainSectionImg06.png" alt="">
            <div class="col-lg-4"></div>

    ...
    <nav class="navbar navbar-expand-lg bg-transparent">
        <div class="container">
            <a class="navbar-brand" href="index.php">
                <img class="w-100" src="Assets/images/Logo/MainLogo.png" alt="">
            </a>
            <button class="navbar-toggler mt-2" type="button" data-bs-toggle="collapse" data-bs-target="#navbarTogglerDemo01" aria-controls="navbarTogglerDemo01" aria-expanded="false" aria-label="Toggle navigation">
                ...
                <ul class="navbar-nav m-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu">
                                <a href="logo-design.php" class="dropdown-item">Logo Design</a>
